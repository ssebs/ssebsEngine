			...
			try
			{
				Display.setIcon(new ByteBuffer[] {
						new ImageIOImageData().imageToByteBuffer(
								ImageIO.read(new File("res/engine/ssebsEngineIcon16.png")), false, false, null),
						new ImageIOImageData().imageToByteBuffer(
								ImageIO.read(new File("res/engine/ssebsEngineIcon32.png")), false, false, null) });

				Display.create();
				loadingTexture = loadTexture(loadingTexture, "res/engine/LoadingTexture.png");
